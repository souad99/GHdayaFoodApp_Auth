...
const CONNECTION_URL = 'mongodb+srv://souad:souad123@cluster0.70rho.mongodb.net/GhdayafoodDB?retryWrites=true&w=majority'
  ...
  Role.estimatedDocumentCount((err, count) => {
    if (!err && count === 0) {
      ...
      new Role({
        ...
        console.log("added 'fournisseur' to roles collection");
      });
    }
  });
}
